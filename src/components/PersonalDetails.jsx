const PersonalDetails = () => {
  return (
    <section className="flex items-center justify-center md:mt-20 mt-15 mx-5 md:mx-0">
      <div className=" text-center" id="personal-details">
        ...
        <svg viewBox="0 0 800 200" width="100%" height="75">
          <text
            ...
            y="50%"
            textAnchor="middle"
            className="animated-text fill-current text-black dark:text-white md:font-[Pacifico] font-[Plus Jakarta Sans]"
          >
            Hi 👋🏿 I'm Elton Morden
          </text>
        </svg>
