...
const Now = () => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen  pt-16 pb-24">
          ...
          >
            {experiences.map((experience, index) => (
              ...
              >
                {/* Timeline dot */}
                <motion.div
                  className="absolute left-0 top-0 w-[10px] h-[10px] rounded-full bg-white dark:bg-slate-800 border-2 border-blue-500 dark:border-blue-400 z-10"
                  initial={{ scale: 0 }}
                ...
                {/* Icon circle */}
                {/* <img src={experience.icon} className="absolute left-[22px] top-0 flex items-center justify-center w-7 h-8 rounded-full  " alt="icons" /> */}
